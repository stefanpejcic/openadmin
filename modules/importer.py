...
def import_users_from_cpanel():
    if request.method == 'GET':
        ...
        return render_template('import/list_import_cp_logs.html', title='cPanel Imports', log_files=log_files)
...
def import_users():
    if request.method == 'GET':
        return render_template('import/import_users.html')
                ...
                if post_response.status_code == 200:
                    ...
                    if token:
                        ...
                        if users_response.status_code == 200:
                            ...
                            return render_template('import/display_users.html', title='Import OpenPanel users', users=formatted_users_data)
                        else:
        ...
        # Example implementation of import process
        # Here you would start your import logic and provide progress updates
        # For simplicity, we are just going to simulate progress
        ...
        while progress < total:
            ...
            progress += 1
            # In a real scenario, you'd perform the actual import operation here
