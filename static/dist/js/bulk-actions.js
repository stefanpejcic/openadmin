...
function bulkActions(cfg) {
    return {
        ...
        bulkSkipped: 0,
        bulkValue: '',
        // for inputs that first pick what to change, like one limit of a plan
        bulkField: '',
        ...
        bulkStart(action, initial, field) {
        ...
        bulkConfirm() {
            ...
            fetch(cfg.endpoint, {
                ...
                body: JSON.stringify({ action: action, field: this.bulkField, value: String(this.bulkValue), items: this.bulkPending })
            })
