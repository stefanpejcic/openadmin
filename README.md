...
The template is built using [tremor](https://tremor.so/), [tailwindcss](https://tailwindcss.com/) and [Alpine.js](https://alpinejs.dev/), providing a clean, responsive, and accessible administration experience.
